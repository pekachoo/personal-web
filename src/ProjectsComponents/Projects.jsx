  ...
  const sideProjects = [
    {
      ...
      description: 'Three motor PID Controlled linear slides with mecanum drive. Python snapscripts and neural network detection was used to align to game pieces. Brought us to FTC Worlds 2024-2025!',
      image: '/projects/ftcworlds.jpg',
      tags: ['Android Studio', 'Java', 'OpenCV', 'Control Theory', 'PID Control', 'AI Detection', 'Odometry'],
    },
    {
      title: 'VEX Worlds',
      description: 'Custom odometry and PID algorithms for autonomous navigation with a differential drive that picked up rings to score. Brought us to 2024-2025 VEX Worlds!',
      image: '/projects/vexworlds.jpg',
      tags: ['C++ (PROS)', 'Odometry', 'Robotics', 'Motion Planning', 'AMCL', 'PID Control'],
    },
    {
      title: '2023-2024 Season VEX Bot',
      description: 'Custom odometry and PID used to autonomously score acorns into a goal. Brought us to 2023-2024 VEX Worlds!',
