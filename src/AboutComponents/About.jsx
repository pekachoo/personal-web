      ...
      <div className="flex flex-col md:flex-row items-start md:items-center gap-12">
        <div className={`flex-1 transition-opacity duration-1000 ${
          ...
          <p className="text-lg text-gray-800 leading-relaxed mb-6">
            I’m a first year computer science student at the University of Waterloo. I’ve found my passion for computer science from being software lead for my FTC Robotics team 18844 and captain of my school's VEX team 19109A. Despite being a computer science major, I actually love engineering and tinkering for projects (you can see some of my projects in the projects tab).
          </p>
